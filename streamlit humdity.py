...
st.title("🌬️ Hirup Pintar – Udara Sehat, Hidup Hebat! 💡")
st.write("Nggak kelihatan bukan berarti aman. Hirup Pintar siap kasih tahu kualitas udara secara real time. 🔍💡")
# === KONFIGURASI UBIDOTS ===
